...
export const SavedPosts = () => {
    ...
    const {
      ...
      isFetching: isSavedPostsFetching,
  ...
  <main>
    <section className="section">
      ...
      <div className="section__body">
        ...
        {/* no saved ids */}
        {!isSavedPostsLoadingQuery && !isSavedPostsErrorQuery && savedPostIds.length === 0 && (
        ...
        {!isSavedPostsLoadingQuery &&
          ...
          savedPosts.length === 0 && (
            <StateView
             {...savedPostsViewContent.errorFindIds}
            />
          )}

        {/* success */}
        {!isSavedPostsLoadingQuery && !isSavedPostsErrorQuery && savedPosts.length > 0 && (
          <PostList
            posts={savedPosts}
