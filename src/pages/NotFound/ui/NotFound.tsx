            ...
            <div className="not-found__inner container">
                <div className="not-found__body">
                    ...
                    <p className="not-found__description">
                        The page you are looking for does not exist or has been moved. Return to the
                        homepage and continue exploring FutureTech.
                    </p>
                ...
                <aside className="not-found__info" aria-label="Page status">
                    ...
                    <div className="not-found__info-body">
                        ...
                        <p className="not-found__info-description">
                            This route is not available yet. Use the homepage to get back to the
                            main content.
                        </p>
                    </div>
                </aside>
