        ...
        <div className="hero__main container">
          ...
          <div className="hero__resources-preview resources-preview">
            <div className="resources-preview__team team">
              <img className="team__person" src="/images/team/1.png" width="60" height="60" loading="lazy" alt=""/>
              <img className="team__person" src="/images/team/2.png" width="60" height="60" loading="lazy" alt=""/>
              <img className="team__person" src="/images/team/3.png" width="60" height="60" loading="lazy" alt=""/>
              <img className="team__person" src="/images/team/4.png" width="60" height="60" loading="lazy" alt=""/>
            </div>
          ...
          <ul className="hero__advantages-list">
            <li className="hero__advantages-item">
              <div className="advantage-card">
                <img src="/icons/updates-icon.svg" width="50" height="50" alt="" className="advantage-card__icon"/>
                <a href="" className="advantage-card__link icon-circle">
                  <h3 className="advantage-card__title h6">
                    Latest News Updates
                  </h3>
            ...
            <li className="hero__advantages-item">
              <div className="advantage-card">
                <img src="/icons/contributors-icon.svg" width="50" height="50" alt="" className="advantage-card__icon"/>
                <a href="" className="advantage-card__link icon-circle">
                  <h3 className="advantage-card__title h6">
                    Expert Contributors
                  </h3>
            ...
            <li className="hero__advantages-item">
              <div className="advantage-card">
                <img src="/icons/readership-icon.svg" width="50" height="50" alt="" className="advantage-card__icon"/>
                <a href="" className="advantage-card__link icon-circle">
                  <h3 className="advantage-card__title h6">
                    Global Readership
                  </h3>
